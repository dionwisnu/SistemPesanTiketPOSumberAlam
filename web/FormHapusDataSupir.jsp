<%-- 
    Document   : FormHapusDataSupir
    Created on : Nov 23, 2014, 12:13:35 PM
    Author     : Dion Wisnu
--%>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <blink><h5 align="center" style="color: red">ID Supir yang dimasukan tidak ditemukan, masukan lagi</h5></blink>
            ...
            %>
        <form action="CekHapusDataSupir.jsp" method="post">
            <table width="350" border="0" align="center">
                <tr>
                    <td width="150">Masukan ID supir</td>
                    <td width="200">
                        <input type="text" name="hapusIdSupir" id="hapusIdSupir" />
                    </td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                    <td>
                        <input type="submit" name="hapusDataSupir" id="hapusDataSupir" value="Hapus" />
                    </td>
                </tr>
            </table>
        </form>
